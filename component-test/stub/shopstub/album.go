...
func (stub *AlbumEndpoints) CreateNewAlbum(
	t *testing.T,
	body *model.Album,
	contentType controller.ContentType) *model.Album {
	response := stub.httpClient.SendPostRequest(t, endpoint.CreateNewAlbum, body, contentType)
	defer response.Body.Close()
